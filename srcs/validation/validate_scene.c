...
/*   Updated: 2023/11/07 11:06:00 by aqueiroz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	validate_line(char *line)
{
	...
	static t_parse parse[] = {{"R ", NULL, 0}, {"A ", validate_ambient, 0},
		{"C ", validate_camera, 0}, {"L ", validate_light, 0}, {"sp",
		validate_sphere, 0}, {"pl", validate_plane, 0}, {"cy",
		validate_cylinder, 0}, {"sq", NULL, 0}, {"tr", NULL, 0}, {NULL, NULL,
		0}};
